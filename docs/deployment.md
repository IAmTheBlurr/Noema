...
6. Optionally set `AI_PROVIDER=gemini` and `ENABLE_AI_DEV_TOOLS=true` for a non-production connectivity environment. Keep developer tools disabled in normal production.
